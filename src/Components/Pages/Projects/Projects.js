    ...
    <div className='my-20 max-w-7xl mx-auto px-10'>
       ...
       <div className="grid grid-cols-2 lg:grid-cols-3 px-5 lg:px-16 gap-3 ">
        <div className=" shadow-md">
          ...
          <h1 className='text-[18px] font-bold mt-4 mb-2 px-4'>Cars Instruments</h1>
        ...
        <div className=" shadow-md">
          ...
          <h1 className='text-[18px] font-bold mt-4 mb-2 px-4'>Home Lanscaping Service</h1>
          <div className="flex flex-col space-y-1 pb-5 px-4">
            <a className='text-sm link text-secondary' href="https://home-landscaper-services.firebaseapp.com/home">Live Link</a>
        ...
        <div className=" shadow-md">
          ...
          <h1 className='text-[18px] font-bold mt-4 mb-2 px-4'>Cryto Cafe</h1>
          <div className="flex flex-col space-y-1 pb-5 px-4">
        ...
        <div className=" shadow-md">
          ...
          <h1 className='text-[18px] font-bold mt-4 mb-2 px-4'>Watch Collection</h1>
          <div className="flex flex-col space-y-1 pb-5 px-4">
            <a className='text-sm link text-secondary' href="https://lambent-quokka-79e933.netlify.app/coins">Live Link</a>
